...
<hr/>
2022/05/03 - 06/14<br>
이 프로젝트는 IoT/Big data/AI/Cloud 분야가 모여 협업한 융복합 프로젝트입니다.
주제는 빅데이터 기반의 AI 추천 광고 키오스크로 저희가 예시로 잡은 곳은 더 현대 서울 내 층별 키오스크를 타겟으로 진행하였습니다.
키오스크에 달린 카메라를 이용하여 안면인식을 한 후 성별/나이대를 추출하여 그에 맞는 더 현대 서울 내 입점한 매장의 위치와 관련광고를 띄워주는 키오스크입니다.
